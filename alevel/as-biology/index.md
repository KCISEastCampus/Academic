...
> **Key point**: How quickly a pathogen causes damage depends on how rapidly it divides.

### 11.2 Data and disease

#### Steps of epidemiological study
1. Local observation
2. Hypothesis
...
> Just because two things are correlated does not mean one causes the other. There must be evidence to prove a causal link.
...
- Do data collectors have a vested interest?
- Has the study been repeated with consistent results/conclusions?
- Are there unanswered questions remaining?

### 11.3 Lifestyle and health

> **Key definition**: **Risk** = the measure of the probability that damage to health will occur as a result of a given hazard.

#### The risk concept has two elements
- Probability of the hazardous event occurring
- Consequences of that hazardous event

#### Analysing the claim “smokers are 15× more likely to develop lung cancer”
When evaluating such statistics, consider:
1. What time period does this cover?
2. Does the number of daily cigarettes affect the figure?
3. Do stress, alcohol, occupation, gender, or pollution influence the result?
4. Does it vary by location (country / city / countryside)?
...
## 🍽️ Chapter 12: Digestion and absorption
...
> **Key definition**: **Digestion** is the process in which large molecules are hydrolysed by enzymes to produce smaller molecules.

#### Two stages of digestion
1. **Physical breakdown** — the breakdown of food into smaller pieces
2. **Chemical digestion** — hydrolysis of large insoluble molecules into small soluble molecules

#### Major structures and their functions

| Structure | Function |
| --- | --- |
| Mouth & salivary glands | Teeth break food into smaller pieces; saliva contains **amylase** which hydrolyses starch into maltose |
| Stomach | Produces **protease**; **HCl** provides suitable pH and destroys pathogens |
| Liver | **Bile salts** emulsify fat and neutralise HCl, providing optimum pH |
| Pancreas | Produces **amylase**, **protease**, and **lipase** |
| Small intestine: duodenum | Acidic stomach contents neutralised by bile; complete chemical digestion occurs here |
...
3. Food enters stomach — acid denatures amylase, stopping starch hydrolysis
4. Food enters small intestine, mixes with pancreatic juice
5. **Amylase** continues starch hydrolysis to maltose; alkaline salts maintain neutral pH
6. Intestinal muscles move food; ileum produces **maltase**, which hydrolyses maltose to **α-glucose**
...
#### Structure of the ileum (adaptations for absorption)
...
5. Epithelial cells lining the villi possess **microvilli**, further increasing surface area

#### Absorption of amino acids and monosaccharides

Protein digestion yields **amino acids**; carbohydrate digestion yields **glucose, fructose, and galactose**. These are absorbed via **facilitated diffusion** and **co-transport**.

**Steps of co-transport:**
1. Sodium ions actively transported (via sodium-potassium pump)
2. Maintains higher Na⁺ concentration outside the cell
3. Na⁺ diffuses into cells down its gradient, carrying amino acids / glucose with it
4. Glucose / amino acids enter blood plasma via facilitated diffusion

> **Key concept — co-transport**: Na⁺ moves down its concentration gradient; glucose / amino acids move against theirs. The Na⁺ gradient powers glucose / amino acid uptake **without direct ATP use**. This is also called **indirect active transport**.
...
7. Enter **lacteals** (lymphatic capillaries in the centre of villi)
8. Pass through lymph vessels into the **blood system**
...
1. Surviving bacteria use flagella in a corkscrew motion to move through intestinal mucus to the gut wall.
2. Bacteria secrete a **two-part toxic protein**.
3. One part binds specific carbohydrate receptors only on small intestine epithelial cells.
4. The toxic fragment enters cells and opens cell-surface **chloride ion channels**.
5. Chloride ions flood from epithelial cells into the intestinal lumen.
6. Cell water potential rises, lumen water potential falls → water moves into the lumen by **osmosis**.
7. Ions diffuse into epithelial cells from blood and tissues, further lowering lumen water potential.
8. More water leaves blood and tissues into the intestine.
...
#### Why plain water is ineffective
...
| Component | Role |
| --- | --- |
| Water | Restores tissue hydration |
| Sodium | Replaces lost ions; uses sodium–glucose co-transporters |
| Glucose | Stimulates sodium uptake + provides energy |
| Potassium | Replaces losses + stimulates appetite |
| Other electrolytes (Cl⁻, citrate) | Corrects ion balance |

### 13.3 The human immunodeficiency virus (HIV)

![Structure of the HIV virus, showing the lipid envelope with attachment proteins, capsid, matrix, genetic material (RNA), and reverse transcriptase enzyme](../../assets/img/as-biology/as-biology-C13-img1.png)

> **Key definition**: HIV is a **retrovirus**. It contains **reverse transcriptase**, which synthesises single-stranded DNA (cDNA) from an RNA template.

#### Replication of HIV
1. HIV enters the bloodstream after infection and circulates around the body.
2. Viral protein binds specifically to the **CD4 protein**, mainly on helper T cells.
3. The viral capsid fuses with the cell membrane, releasing HIV RNA and enzymes into the host cell.
4. **Reverse transcriptase** converts viral RNA into double-stranded DNA.
5. New viral DNA enters the nucleus and inserts into the host cell’s own DNA.
6. Using host enzymes, viral DNA produces mRNA coding for new viral proteins and RNA.
7. mRNA exits the nucleus and uses host cell machinery to assemble HIV particles.
8. New viruses **bud off** from the cell surface, taking host membrane to form their lipid envelope.
...
#### HIV replication in T helper cells — summary
...
5. This destroys the T helper cell, eventually leading to a dramatic reduction in the immune capability of the host.

> A person infected with HIV is said to be **HIV positive**.
...
> There is **no cure** for HIV. Infection is controlled using **antiretroviral therapy (ART)**. Different drugs target separate stages of HIV replication and spread inside the human body.

| Type of drug | Site of action |
| --- | --- |
| Attachment & entry inhibitors | Block the attachment points for the HIV viral protein onto the helper T cell; some bind to proteins on the virus, others bind to receptors on the cell. |
| Reverse transcriptase inhibitors | Two types: **non-nucleoside inhibitors** act as non-competitive inhibitors, binding away from the active site; **nucleoside inhibitors** act as alternative nucleotides, terminating the polynucleotide chain when incorporated. |
| Integrase inhibitors | Act on the enzyme responsible for inserting the viral DNA copy into the host genome (integration). |
| Protease inhibitors | Inhibit the enzymes responsible for completing the modification of proteins incorporated into new virus particles. |
...
## 🛡️ Chapter 14: Mammalian blood — defensive mechanisms

### 14.1 Cell recognition and the cells of the immune system

![Defence mechanisms diagram showing the division into non-specific responses (physical barriers such as skin, and phagocytosis) and specific responses (cell-mediated response via T lymphocytes, and humoral response via B lymphocytes)](../../assets/img/as-biology/as-biology-C14-img1.png)

Mammalian immune defence mechanisms are divided into two main categories:
...
> **Key definition**: **Phagocytosis** is a core non-specific immune response that destroys pathogens via phagocytic white blood cells.

![Diagram of the phagocytosis process showing a phagocyte engulfing a pathogen, forming a phagosome, and digesting it with lysosomes](../../assets/img/as-biology/as-biology-C14-img2.png)
...
> **Antigen**: Specific cell-surface molecules (usually **proteins** on cell membranes / walls) that act as cell identifiers. The immune system distinguishes **self** and **non-self** cells by recognising unique antigen patterns.

> **Lymphocytes**: Specialised white blood cells for specific immunity, maturing in different sites:
...
![Diagram of the cell-mediated immune response pathway](../../assets/img/as-biology/as-biology-C14-img3.png)
...
> **Key concept**: Cytotoxic T cells kill abnormal / pathogen-infected cells by producing **perforin** — a protein that forms holes in the target cell’s membrane, making it fully permeable and causing the cell to lyse and die.
...
> **Key definition**: **Humoral immunity** is antibody-mediated immunity that acts in the **blood plasma and tissue fluid** (the "humors"), targeting free pathogens (not infected cells). B cells are the primary mediators, with each B cell producing antibodies specific to one antigen.

#### B cell differentiation

After activation, each B cell clone develops into two specialised cell types:
...
![Memory cells diagram](../../assets/img/as-biology/as-biology-C14-img4.png)

#### Humoral immune response steps

![Steps of the humoral immune response](../../assets/img/as-biology/as-biology-C14-img5.png)
...
![Antibody structure diagram showing two heavy chains and two light chains linked by disulfide bridges, with variable regions forming the antigen-binding site and constant regions for immune cell interaction](../../assets/img/as-biology/as-biology-C14-img6.png)
...
2. **Opsonisation**: Antibodies act as **markers** on pathogen surfaces, stimulating phagocytes to recognise and engulf the attached pathogens.

### 14.5 Vaccination

> **Key definition**: **Immunity** is the ability of an organism to resist infection by disease-causing microorganisms (pathogens). Vaccination is the basis of **artificial active immunity**, inducing a specific immune response without causing the full disease.
...
| Induction type | Active | Passive |
|---|---|---|
| **Natural** | Exposure to a live pathogen (infection) | Antibodies from another organism (e.g., placenta / breast milk) |
| **Artificial** | Vaccination (inactivated / attenuated pathogen / antigen) | Injected manufactured antibodies (e.g., snake bite anti-venom, monoclonal antibodies) |
...
>   - **Artificial active** — from vaccination (core of immunisation programmes).
...
> **Key definition**: **Herd immunity** occurs when a large proportion of the population is vaccinated, creating an indirect barrier to pathogen spread.
...
- **Essential for**: Individuals who cannot be vaccinated safely (e.g., babies with immature immune systems, immunocompromised people, those with medical contraindications).
- **Optimisation**: Achieved best by mass vaccination at the same time, temporarily reducing disease cases and interrupting pathogen transmission (the required percentage varies by disease).
...
> **Key definition**: **Antigen variability** is the change in the structure / shape of pathogen surface antigens due to **random genetic mutations**.
...
- Mutated antigens are unrecognisable by existing memory cells, meaning the immune system mounts a slow **primary response** instead of a rapid secondary response.
...
## ❤️ Chapter 15: Mammalian blood — the circulatory system

### 15.1 Circulatory system of a mammal

#### Mass transport
Two key factors determine the need for mass transport:
1. **SA:V ratio** — smaller organisms have a larger surface area to volume ratio
2. **Activity level** — more active organisms need faster transport

#### Features of transport systems
1. Efficient internal transport
2. A transport medium
3. Mass transport capability
...
> **Key concept**: In a **double circulatory system**, blood passes **twice through the heart** per full body circuit.

- Blood pressure reduces after passing through the lungs
- Low pressure would slow circulation to body tissues
- Blood returns to the heart to **boost pressure**
- Fast delivery of substances
- Suits mammals: high body temperature & **high metabolic rate**

![Diagram of the mammalian double circulatory system, showing deoxygenated blood (blue) and oxygenated blood (red) pathways through the heart, lungs, and body tissues](../../assets/img/as-biology/as-biology-C15-img0.png)

#### Closed & double characteristics
- **Closed**: Blood is contained in blood vessels — always in the heart, arteries, veins, or capillaries
- **Double**: Blood passes through the heart twice in one complete circuit

One circuit = two circulations:
1. **Pulmonary circulation** — through the lungs and heart
2. **Systemic circulation** — through the rest of the body and heart (excluding the lungs)
...
#### Common basic layers (arteries, arterioles, veins)
...
> **Function**: Transport blood **rapidly and at high pressure** from the heart to tissues.

- Thick muscle layer: controls blood volume flow
- Thick elastic layer: maintains high pressure & smooths pressure surges
- Thick wall: resists bursting
- No valves: pressure prevents back-flow

#### Arteriole structure — function adaptations

> **Function**: **Control blood flow** into capillary networks.

- Thicker muscle layer relative to size: controls blood flow into capillaries
...
> **Function**: Transport blood **slowly and under low pressure** back to the heart.

- Thin muscle layer: no need to control blood flow
- Thin elastic layer: no stretch / recoil needed
...
> **Function**: **Exchange materials** between blood and tissues.
...
- Narrow diameter: close to surrounding cells
- Very narrow lumen: reduces diffusion distance for O₂
- Gaps between endothelial cells: allow WBCs to escape for immune response

#### Formation of tissue fluid
- Blood flow creates **hydrostatic pressure** at the arterial end of capillaries
...
> Not all tissue fluid returns to capillaries; the rest enters the **lymphatic system**.
...
- Mammal adaptation: blood returns to the heart to **increase pressure** before body distribution.
- **Right ventricle**: Thinner muscular wall; pumps blood to lungs
- **Left ventricle**: Thick muscular wall; generates sufficient pressure to pump blood to the body
- Two separate pumps, no blood mixing after birth
...
#### Vessels connected to the four chambers

| Vessel | Connection | Blood type |
|---|---|---|
| **Aorta** | Left ventricle → body (except lungs) | Oxygenated |
| **Vena cava** | Body tissues → right atrium | Deoxygenated |
| **Pulmonary artery** | Right ventricle → lungs | Deoxygenated *(unusual for an artery)* |
| **Pulmonary vein** | Lungs → left atrium | Oxygenated *(unusual for a vein)* |

#### Heart muscle oxygen supply
- Oxygenated blood in the left heart does **not** supply the heart muscle itself.
- Heart muscle is supplied by **coronary arteries** (branch from the aorta).
...
2. **Semi-lunar (SL) valve**
3. **Pocket valve** (in veins)

> Valves only open one way — whether they are open or closed depends on the relative pressure of the heart chambers.

> Pressure is usually measured on the **left side** of the heart (left atrium, left ventricle, aorta) due to higher pressure and larger pressure differences compared to the right side.

#### Three stages of the cardiac cycle

**1. Atrial systole** — ventricles relax, atria contract

The ventricles are relaxed. The atria contract, decreasing the volume of the chambers and increasing the pressure inside. This pushes blood into the ventricles. There is a slight increase in ventricular pressure and chamber volume as the ventricles receive the ejected blood from the contracting atria.
...
The ventricles and atria both relax. The higher pressure in the pulmonary artery and aorta closes the **SL valves** to prevent back-flow into the ventricles. Blood returns to the heart and the atria fill again due to the higher pressure in the vena cava and pulmonary vein. As the ventricles continue to relax, their pressure falls below the pressure of the atria and so the **AV valves open**. This allows blood to flow passively (without being pushed by atrial contraction) into the ventricles from the atria. The atria contract, and the whole process begins again.

#### Key definitions

> **Systole** = contraction · **Diastole** = relaxation
>
> Blood flows from higher to lower pressure. Contraction increases the pressure. Valves open / close according to pressure gradients:
> - AV valves open: P_atrium > P_ventricle; closed: P_atrium < P_ventricle
> - SL valves open: P_ventricle > P_artery; closed: P_ventricle < P_artery

#### Cardiac output

> **Key definition**: **Cardiac output** = the volume of blood pumped by **one ventricle** in **one minute** (unit: dm³·min⁻¹)
...
![Pressure and volume changes during the cardiac cycle — reference diagram 1](../../assets/img/as-biology/as-biology-C15-img1.png)

![Pressure and volume changes during the cardiac cycle — reference diagram 2](../../assets/img/as-biology/as-biology-C15-img2.png)
...
- Normal human blood pressure is usually between **80–120 mmHg**
...
#### Aneurysm
- **Cause**: Atheromas **weaken artery walls**
...
> **Key definition**: **Myocardial infarction** (heart attack) = reduced oxygen supply to the heart muscle (**myocardium**), caused by **blockage in the coronary arteries** (almost always linked to atheroma; many cases involve coronary thrombosis).
...
> **HDLs (High-density lipoproteins)**: Remove cholesterol from tissues, transport to liver for excretion → **protect arteries** against heart disease.

> **LDLs (Low-density lipoproteins)**: Transport cholesterol from liver to tissues (including artery walls) → infiltrate artery walls → lead to **atheroma development** → increase heart disease risk.
...
![Root structure of a dicotyledonous plant showing root hairs, cortex, endodermis, and xylem](../../assets/img/as-biology/as-biology-C16-img1.png)

#### Root structure and water absorption basis

Most plants are terrestrial, evolving water-conserving adaptations (e.g., waterproof outer layer), so they cannot absorb water via the general body surface. Instead, they have a specialised exchange surface in the soil: **root hairs**.

![Structure of phloem showing sieve plates and companion cells](../../assets/img/as-biology/as-biology-C16-img2.png)

> Phloem is made up of living cells that have **sieve plates** between them and **companion cells** beside them, which provide metabolic support.

#### Uptake of water by root hairs

Root hairs are plants’ exchange surfaces for absorbing water and mineral ions. Plants lose large amounts of water via transpiration (up to **700 dm³ / day** in large trees), which must be replaced by root hair absorption.

**Adaptations for efficient absorption**:
- Long extensions + thousands per root branch (large surface area)
- Thin cell-surface membrane and cellulose cell wall (rapid material movement)
...
As water enters endodermal cells by osmosis, cohesive water molecules pull more water behind them, creating tension. This tension draws water along the **cell walls** of root cortex cells. The mesh-like cellulose cell walls have abundant water-filled spaces, resulting in little to no resistance to water movement.

#### Symplastic pathway

![Symplastic pathway diagram showing water movement through cytoplasm via plasmodesmata](../../assets/img/as-biology/as-biology-C16-img3.png)

Occurs via the **cytoplasm** of cortex cells (osmosis-driven), with water passing through cell walls via **plasmodesmata** (cytoplasm-filled tiny openings). A continuous cytoplasm column connects root-hair cells to root-centre xylem.
...
In the apoplastic pathway, the waterproof **Casparian strip** in endodermal cells blocks water movement along cell walls. Water then enters the cell’s living protoplast and joins water from the symplastic pathway.

Endodermal cells **actively transport salts** into the xylem (requires energy, carrier proteins, living tissue). This lowers xylem water potential, so water moves in by osmosis, creating **root pressure** that pushes water upward. Root pressure is important in small herbaceous plants but negligible in large trees compared to transpiration pull.
...
Atmospheric humidity (and water potential) is usually lower than that of the air spaces adjacent to stomata. When stomata are open, water vapour diffuses out of the air spaces into the atmosphere down the water potential gradient. Water lost from the air spaces is replenished by evaporation from the cell walls of surrounding mesophyll cells. Plants control transpiration rate by adjusting the size of stomatal pores.

#### Movement of water across leaf cells

Mesophyll cells lose water via evaporation from cell walls to leaf air spaces. Lost water is replaced by water from the xylem, moving through apoplastic or symplastic pathways.

**Symplastic pathway mechanism**:
1. Mesophyll cells lose water to air spaces, lowering their water potential.
2. These cells take in water by osmosis from neighbouring cells.
3. Neighbouring cells lose water, reducing their water potential.
4. They absorb water from their own neighbours by osmosis.
...
> - Transpiration pull is powerful enough to lift water **100 m+** in the tallest trees.
...
> Transpiration pull is **passive** and requires no metabolic energy. Xylem vessels are dead, so their end walls break down, forming continuous, unbroken tubes from roots to leaves — essential for the cohesion-tension theory. Energy for transpiration comes from heat, ultimately supplied by the Sun.

### 16.3 Transpiration and factors affecting it

#### Role of transpiration

Transpiration is called a **"necessary evil"**: unavoidable in flowering plants due to leaf adaptations for photosynthesis (large surface area for light absorption, stomata for CO₂ intake), causing huge water loss (up to 700 dm³ daily in large trees). It is not essential for water delivery to leaves (osmosis could do this), and < 1% of transported water is used by the plant.
...
Transpiration in xylem can be measured using a **potometer**.

#### Factors affecting transpiration

| Factor | How it affects transpiration | Increase in transpiration | Decrease in transpiration |
|--------|------------------------------|---------------------------|---------------------------|
| **Light** | Stomata open in the light and close in the dark | Higher light intensity | Lower light intensity |
| **Temperature** | Alters the **kinetic energy** of water molecules and the relative humidity of the air | Higher temperatures | Lower temperatures |
...
![Diagram showing the transport of organic substances in the phloem, including source-to-sink mass flow](../../assets/img/as-biology/as-biology-C16-img5.png)
...
![Evidence table for phloem translocation](../../assets/img/as-biology/as-biology-C16-img6.png)

### 16.5 Investigating transport in plants

#### Ringing experiments

Woody stems have a layer of phloem cut from their circumference. The tissue below the cut dies and the tissue above swells. These observations suggest:
...
Aphids feed by inserting their needle-like stylets into the phloem to withdraw sap. Sieve tube sap is under hydrostatic pressure, causing sap to exude from the aphid’s rear. This exudate is sticky, sugar-rich, and supports mould growth. In heavy infestations, black moulds reduce leaf photosynthesis and lower crop yields.
...
Like animal viruses, plant viruses consist of **nucleic acid and a protein coat**; some also have an outer membrane. Shapes vary: tobacco mosaic virus (TMV) is rigid rods; others are spherical. They only reproduce inside host cells but cannot penetrate cuticles or cell walls. Entry occurs via damaged tissue or vectors (aphids, fungi, nematodes). Viruses spread systemically throughout the plant and can be passed to the next generation via seeds and vegetative structures (e.g. tubers).
...
![Graph showing variations in cell mass and DNA mass during the cell cycle, with DNA doubling during S phase and cell mass increasing then halving at division](../../assets/img/as-biology/as-biology-C17-img1.png)

The majority of the cell cycle is spent in **interphase** — this is when the cell is growing and DNA is replicated. The DNA is uncondensed and replicated so the amount of DNA doubles, ensuring each cell will have the same amount. Organelles are also replicated so there will be enough for both new cells. The amount of ATP being produced is increased as energy is required for cell division.

![Cell cycle diagram showing the phases of interphase and cell division](../../assets/img/as-biology/as-biology-C17-img2.png)
...
- **G₁ (gap 1)** phase: the cell elongates and new organelles and proteins are made
- **S (synthesis)** phase: the cell replicates its DNA — this is essential before the cell can divide
- **G₂ (gap 2)** phase: the cell keeps elongating and proteins needed for cell division are made

#### Mitosis

**1. Prophase**

The chromosomes condense (they thicken and shorten as DNA is coiled tightly around proteins called **histones**) and become visible. The nucleolus disappears. The nuclear envelope begins to break down. The centrioles move to the poles of the cell. The centrioles (bundles of protein) begin to produce **spindle fibres** which start to extend towards the chromosomes.

![Prophase — chromosomes condense, centrioles move to poles, spindle fibres form](../../assets/img/as-biology/as-biology-C17-img3.png)

**2. Metaphase**

The nuclear membrane has disappeared. Spindle fibres have attached to the **centromere** of each chromosome. Each centromere has a spindle fibre from each pole of the cell. Chromosomes are pulled to the **middle / equator** of the cell where they line up.

![Metaphase — chromosomes line up at the equator, spindle fibres attached](../../assets/img/as-biology/as-biology-C17-img4.png)

**3. Anaphase**

The spindle fibres contract. The centromere of each chromosome splits in half so that one chromatid from each chromosome can be pulled to **opposite poles** of the cell. This stage ensures that each half of the cell receives one chromatid from each chromosome. This stage can be recognised by the **V-shape** of the chromatids as they are dragged across.

![Anaphase — chromatids pulled to opposite poles, V-shape visible](../../assets/img/as-biology/as-biology-C17-img5.png)

**4. Telophase**

Nuclear envelopes begin to reform around each new group of chromosomes. The spindle fibres disappear. The chromosomes begin to uncoil / unravel and become less distinct. The cytoplasm begins to divide to form two new **genetically identical** daughter cells. Each new cell will have half the amount of DNA compared to the cell in interphase, until interphase begins again and DNA is replicated.

![Telophase — nuclear envelopes reform, cytoplasm divides](../../assets/img/as-biology/as-biology-C17-img6.png)

![Summary diagram showing the stages of mitosis in an animal cell](../../assets/img/as-biology/as-biology-C17-img7.png)

#### The importance of mitosis

> **1. Growth**: When two haploid cells (sperm and ovum) fuse to form a diploid cell with full genetic information. Mitosis produces genetically identical cells for the new organism to grow and resemble parents.

> **2. Differentiation**: Cells differentiate into specialised cells (e.g. epithelium, xylem). These cells divide by mitosis to form efficient tissues with identical structure and function.

> **3. Repair**: Damaged or dead cells are replaced by new identical cells produced by mitosis. This maintains effective tissue function.

### 17.2 Binary fission

![Diagram of binary fission in bacteria](../../assets/img/as-biology/as-biology-C17-img8.png)

#### Binary fission vs mitosis

Bacteria reproduce through **binary fission** — a form of asexual reproduction. It is very similar to mitosis. The DNA of a prokaryotic cell is not linear and it does not condense into chromosomes because it does not associate with histone proteins; it is a **single loop of circular DNA**.

![Comparison of binary fission and mitosis](../../assets/img/as-biology/as-biology-C17-img9.png)
...
**Result**: The recipient cell gains new characteristics from the donor.
...
> **Key definition**: A change to the quantity or structure of DNA is called a **mutation**.
...
A change to one or more nucleotide bases or their rearrangement in DNA is a **gene mutation**. DNA triplets are transcribed into mRNA and translated into a polypeptide’s amino acid sequence. A change in DNA bases may alter the amino acid sequence.
...
A deletion mutation occurs when a nucleotide is lost from the DNA sequence. Even one lost nucleotide can drastically change the amino acid sequence.

The genetic code is read in **triplets** (three bases). One deleted base causes a **frame-shift** — the reading frame shifts left by one base. All following triplets are read incorrectly, altering the whole polypeptide.

A deletion near the start affects all triplets; a deletion near the end has a smaller effect but still alters the protein.

![Diagram showing how proto-oncogenes regulate cell division: normal pathway shows growth factor binding to a receptor protein, activating DNA replication genes, and controlled cell division; mutated pathways show oncogene formation leading to uncontrolled division and tumour formation](../../assets/img/as-biology/as-biology-C17-img11.png)

#### Causes of mutations

Gene mutations arise **spontaneously** during DNA replication, with no outside influence. They are random but have a predictable rate: about **1–2 mutations per 100,000 genes per generation**. This rate is increased by **mutagenic agents (mutagens)**, including:
...
> Cell division is controlled by genes. Normal cell division is tightly regulated by two types of genes.

##### 1) Proto-oncogenes: stimulate cell division

![Diagram of normal cell division control: a growth factor binds to a receptor protein at the cell-surface membrane, activating relay proteins in the cytoplasm and then a nuclear protein in the nucleus, which switches on genes needed for DNA replication](../../assets/img/as-biology/as-biology-C17-img12.png)

**Role of proto-oncogenes**: Growth factors bind to cell membrane receptors, activating genes for DNA replication.
...
Research into inherited cancers led to the discovery of **tumour suppressor genes**. These genes **inhibit** cell division, the opposite of proto-oncogenes.
