...
- **General formula**: Represents a homologous series of compounds using letters and numbers  
  Example: The general formula of alkanes is $\mathrm{C_{n}H_{2n+2}}$
- **Molecular formula**: Shows the exact number and type of each atom in a molecule  
  Example: The molecular formula of ethanoic acid is $\mathrm{C_2H_4O_2}$
- **Empirical formula**: Shows the simplest whole number ratio of elements present in a compound  
  Example: The empirical formula of ethanoic acid is $\mathrm{CH_2O}$
- **Structural formula**: Shows how atoms are bonded to each carbon atom in a molecule
...
- Members have gradually changing physical properties (boiling point, melting point, density)
...
| 7                 | hept-               | heptane                        | $\mathrm{C_7H_{16}}$ |
| 8                 | oct-                | octane                         | $\mathrm{C_8H_{18}}$ |
...
|-------------------|---------------------|--------|
| 1                 | $\mathrm{CH_3-}$    | methyl-|
| 2                 | $\mathrm{C_2H_5-}$  | ethyl- |
...
![IMG](<../../assets/img/as-chem/C11-img (12).png>)
![IMG](<../../assets/img/as-chem/C11-img (13).png>)
...
![IMG](<../../assets/img/as-chem/C11-img (16).png>)

##### Heterolytic Fission
A type of bond fission where the bond pair of electrons is retained entirely by one of the two atoms, forming positive and negative ions.
...
![IMG](<../../assets/img/as-chem/C11-img (18).png>)

2. **Functional group isomerism**: Different functional groups present
![IMG](<../../assets/img/as-chem/C11-img (19).png>)
...
- **E isomers**: Functional groups on the **opposite sides** of the double bond/ring

> Note: Cis/trans isomerism is a special case of E/Z isomerism, where *cis* ≈ Z and *trans* ≈ E.

![IMG](<../../assets/img/as-chem/C11-img (21).png>)

Substituted groups joined by a single bond can rotate freely, so no isomerism occurs. However, there is no rotation around a double bond, so E- and Z-isomers are distinct compounds that cannot be easily interconverted.
...
- **General formula**: 
  ...
  - Cycloalkanes (rings): $\mathrm{C_{n}H_{2n}}$
...
##### 2. Boiling Points
Boiling points increase with increasing chain length due to stronger van der Waals forces:
- $\mathrm{C_1-C_4}$: Gases at room temperature
- $\mathrm{C_5-C_{17}}$: Liquids at room temperature (lower boiling points for shorter chains)
- $\mathrm{C_{18}}$ and above: Waxy solids at room temperature

**Branched vs straight-chain isomers**: Branched alkanes have lower boiling points than their straight-chain counterparts with the same number of carbon atoms. This is because branched chains pack less closely together, resulting in weaker van der Waals forces.

##### 3. Solubility
- Alkanes are **insoluble in water** (water molecules are held together by strong hydrogen bonds, which are much stronger than van der Waals forces)
- Alkanes mix freely with other non-polar liquids

##### 4. Chemical Reactivity
Alkanes are generally unreactive due to the high strength of C–C and C–H single bonds. They do not react with acids, bases, oxidising agents or reducing agents under normal conditions. However, they undergo two important types of reactions:
...
**Process**:
1. Crude oil is heated in a furnace to form a liquid-vapour mixture, which enters a fractionating tower (hot at the bottom, cool at the top)
2. Vapours rise through the tower and cool, condensing into liquids when the temperature falls below their boiling point
3. Shorter-chain hydrocarbons have lower boiling points and condense near the cooler top of the tower
4. Longer-chain hydrocarbons have higher boiling points and condense near the hotter bottom
5. A thick residue (tar/bitumen) collects at the base, used for road surfacing or further processing
...
- **Reaction characteristics**:
  - C–C bonds can break at any position along the chain
  - Hydrogen gas may also be formed
  - Reaction time is very short (~1 second) to prevent complete decomposition into carbon and hydrogen
...
4. **Particulates**: Tiny carbon particles that exacerbate asthma and cause cancer
5. **Unburnt hydrocarbons**: Greenhouse gases that contribute to photochemical smog
...
- **Calcium carbonate (limestone)**: Also reacts with $\mathrm{SO_2}$ to form calcium sulfate

##### Catalytic Converters
Fitted to car exhaust systems to reduce emissions of carbon monoxide, nitrogen oxides and unburnt hydrocarbons:
- **Structure**: Honeycomb shape provides enormous surface area
...
##### Initiation
The halogen molecule absorbs UV light, causing homolytic fission of the halogen-halogen bond to form two halogen free radicals:
$$\mathrm{Cl_2 \xrightarrow{UV} 2Cl \cdot}$$
$$\mathrm{Br_2 \xrightarrow{UV} 2Br \cdot}$$

The C–H bond in alkanes requires more energy to break than is available in a single quantum of UV radiation, so it does not break during initiation.

![IMG](<../../assets/img/as-chem/C12-img (3).png>)

##### Propagation
Free radicals react with alkane molecules to form new free radicals, continuing the chain reaction:

![IMG](<../../assets/img/as-chem/C12-img (4).png>)


##### Termination
Two free radicals react together to form a stable molecule, ending the chain reaction:
$$\mathrm{CH_3 \cdot + Cl \cdot \rightarrow CH_3Cl}$$
$$\mathrm{CH_3 \cdot + CH_3 \cdot \rightarrow CH_3CH_3}$$
...
- **Environmental importance**: Chlorofluorocarbons (CFCs) undergo similar free radical reactions in the stratosphere, destroying the ozone layer:
  1. C–Cl bonds in CFCs break homolytically under UV radiation to form chlorine free radicals: $\mathrm{CCl_3F \xrightarrow{UV} \cdot CCl_2F + Cl \cdot}$
  2. Chlorine radicals attack ozone molecules: $\mathrm{Cl \cdot + O_3 \rightarrow ClO \cdot + O_2}$
  3. The ClO· radical reacts with another ozone molecule, regenerating the Cl· radical: $\mathrm{ClO \cdot + O_3 \rightarrow 2O_2 + Cl \cdot}$
  4. Overall reaction: $\mathrm{2O_3 \rightarrow 3O_2}$

The chlorine radical acts as a catalyst, destroying thousands of ozone molecules before being removed from the atmosphere. The ozone layer protects Earth from harmful UV radiation, which causes skin cancer and damages DNA.
...
- Mix freely with hydrocarbons, making them useful as dry-cleaning fluids and for removing oily stains

##### 2. Boiling Points
- Boiling points **increase with increasing carbon chain length**
- Boiling points **increase down the halogen group** (F < Cl < Br < I)
  - Both effects are due to stronger van der Waals forces from more electrons in larger molecules
- Increased branching of the carbon chain lowers boiling points (less efficient packing)
- Halogenoalkanes have higher boiling points than alkanes of similar chain length due to:
...
|--------|------------|---------------------|
| **Bond polarity** | C–F (most polar) > C–Cl > C–Br > C–I (least polar) → Fluoroalkanes most reactive | ❌ |
| **Bond enthalpy** | C–F (strongest) > C–Cl > C–Br > C–I (weakest) → Iodoalkanes most reactive | ✅ |
...
- **Electrophile**: An electron-deficient species that accepts a pair of electrons to form a covalent bond
...
**General mechanism**:
![IMG](<../../assets/img/as-chem/C13-img (2).png>)
...
![IMG](<../../assets/img/as-chem/C13-img (3).png>)

##### 2. Reaction with Cyanide Ions
- **Conditions**: Ethanolic solution of potassium cyanide, heated under reflux
- **Product**: Nitrile ($\mathrm{R-CN}$)
- **Important**: The product has **one more carbon atom** than the starting halogenoalkane, making this reaction useful for extending carbon chains
- **General equation**:
  $$\mathrm{R-X + CN^- \rightarrow R-CN + X^-}$$
<!-- ![IMG](<../../assets/img/as-chem/C13-img (4).png>) -->


##### 3. Reaction with Ammonia
- **Conditions**: Excess concentrated ammonia in ethanol, heated under pressure
- **Product**: Primary amine ($\mathrm{R-NH_2}$)
- **General equation**:
  $$\mathrm{R-X + 2NH_3 \rightarrow R-NH_2 + NH_4X}$$

**Mechanism notes**:
- Ammonia is a neutral nucleophile with a lone pair on nitrogen
...
- **Conditions**:
  1. Sodium/potassium hydroxide dissolved in **ethanol** (no water present)
  2. Heated mixture
- **Product**: Alkene
- **General process**:
  1. $\mathrm{OH^-}$ uses its lone pair to form a bond with a slightly positive hydrogen atom on the carbon adjacent to the C–X bond
  2. The electron pair from the C–H bond forms a C=C double bond
  3. The halogen atom leaves as a halide ion ($\mathrm{X^-}$)
...
| Temperature | Room temperature | High temperature (heated) |
| Halogenoalkane type | Primary | Tertiary |
...
**Example**: Elimination from 2-chlorobutane produces:
1. But-1-ene
2. Z-but-2-ene
3. E-but-2-ene
...
**Properties**:
- Extremely unreactive under normal conditions
- Short-chain CFCs are gases
- Longer-chain CFCs are liquids

**Historical uses**:
- Aerosol propellants
- Refrigerants
- Blowing agents for foams (e.g., expanded polystyrene)
- Dry cleaning and degreasing solvents

**Environmental impact**:
- CFCs drift up to the stratosphere where UV radiation causes homolytic fission of C–Cl bonds, producing chlorine free radicals
- These radicals catalyze the breakdown of ozone ($\mathrm{O_3}$), which protects Earth from harmful UV radiation
- Ozone depletion increases the risk of skin cancer, DNA damage and harm to marine ecosystems
...
- All alkenes have a planar geometry around the carbon-carbon double bond

![IMG](<../../assets/img/as-chem/C14-img (1).png>)

##### 2. Bonding in Alkenes
A C=C double bond consists of:
- One **σ (sigma) bond**: Formed by head-on overlap of atomic orbitals
- One **π (pi) bond**: Formed by side-on overlap of p-orbitals, with electron density above and below the σ bond

The π bond is responsible for the restricted rotation around the double bond.
...
1. HBr is polar: $\mathrm{H^{\delta+}–Br^{\delta-}}$ (Br is more electronegative than H)
2. $\mathrm{H^{\delta+}}$ acts as the electrophile, attracted to the C=C double bond
3. The π bond electrons form a bond with $\mathrm{H^{\delta+}}$, causing heterolytic fission of the H-Br bond
4. A carbocation and a bromide ion ($\mathrm{Br^-}$) are formed
5. $\mathrm{Br^-}$ attacks the carbocation, forming bromoethane

![IMG](<../../assets/img/as-chem/C14-img (3).png>)

##### Asymmetrical Alkenes and Markovnikov's Rule
When adding a hydrogen halide to an asymmetrical alkene, two possible products can form. The **major product** is formed from the **most stable carbocation**.
...
**Markovnikov's Rule**: The electrophile adds to the carbon atom of the double bond with the most hydrogen atoms, and the nucleophile adds to the carbon with the most alkyl groups.

![IMG](<../../assets/img/as-chem/C14-img (5).png>)

**Example**: Addition of HBr to propene produces mainly 2-bromopropane (major product) and a small amount of 1-bromopropane (minor product).
...
1. A bromine molecule develops an instantaneous dipole: $\mathrm{Br^{\delta+}–Br^{\delta-}}$
2. $\mathrm{Br^{\delta+}}$ is attracted to the electron-rich C=C double bond
3. The π bond electrons form a bond with $\mathrm{Br^{\delta+}}$, causing heterolytic fission of the Br-Br bond
4. A carbocation and a bromide ion ($\mathrm{Br^-}$) are formed
5. $\mathrm{Br^-}$ attacks the carbocation, forming 1,2-dibromoethane
...
**Overall effect**: Addition of water across the double bond (hydration)
...
|---------|---------|-------------|--------------|
| Ethene ($\mathrm{CH_2=CH_2}$) | Poly(ethene) | Polythene | Carrier bags, washing up bowls |
| Propene ($\mathrm{CH_2=CHCH_3}$) | Poly(propene) | Polypropylene | Yoghurt containers, car bumpers |
| Chloroethene ($\mathrm{CH_2=CHCl}$) | Poly(chloroethene) | PVC | Aprons, vinyl records, drainpipes |
...
1. **Mechanical recycling**: Separate → wash → grind into pellets → melt and remould
   - Example: Recycled PET bottles used to make fleece clothing
2. **Feedstock recycling**: Heat plastics to break polymer bonds, forming monomers that can be used to make new plastics
...
A competing complete combustion reaction also occurs:
$$\mathrm{CH_2=CH_2 + 3O_2 \rightarrow 2CO_2 + 2H_2O}$$
...
$$\mathrm{CH_2CH_2O + H_2O \rightarrow HOCH_2CH_2OH}$$

Further reaction produces polyethylene glycols (PEGs) of different chain lengths:
- n=1: Production of PET (polyethylene terephthalate) for soft drink bottles
- n=2: Manufacture of polyurethane plastics
- n=3: Plasticiser for PVC
- n=4+: Detergents, cosmetics, paints

##### 2. Reaction with Alcohols
Produces compounds of the form $\mathrm{RO-CH_2CH_2-OH}$, used as solvents and surfactants.

##### 3. Reaction with Ammonia
Produces ethanolamines, used in cosmetics, soaps and detergents.
...
- **C-O-H bond angle**: Approximately 105° (compressed from the ideal tetrahedral angle of 109.5° due to greater repulsion between lone pairs)
...
- **Conditions**:
  1. Excess hot concentrated sulfuric acid
  2. Or passing alcohol vapour over heated aluminium oxide ($\mathrm{Al_2O_3}$) at 600 K
  3. Phosphoric(V) acid ($\mathrm{H_3PO_4}$) can also be used as an alternative dehydrating agent

**Example**: Dehydration of propan-1-ol to propene
$$\mathrm{CH_3CH_2CH_2OH \xrightarrow{Al_2O_3, 600K} CH_3CH=CH_2 + H_2O}$$
...
|--------------|---------------------|---------------------|
| **Primary ($1^\circ$)** | Aldehyde ($\mathrm{RCHO}$) | Carboxylic acid ($\mathrm{RCOOH}$) |
| **Secondary ($2^\circ$)** | Ketone ($\mathrm{RCOR'}$) | No further oxidation |
| **Tertiary ($3^\circ$)** | No oxidation under normal conditions | - |

**Reason**: Tertiary alcohols cannot be easily oxidised because this would require breaking a strong C-C bond, rather than a C-H bond which is broken during the oxidation of primary and secondary alcohols.

##### 1. Oxidation of Primary Alcohol to Aldehyde
- **Conditions**: Dilute sulfuric acid, **limited** oxidising agent, gentle heating, distillation
- **Purpose**: To prevent further oxidation to carboxylic acid
- **Mechanism**: The aldehyde vaporises immediately and is distilled off before it can be oxidised further

**Example**: Oxidation of ethanol to ethanal
$$\mathrm{CH_3CH_2OH + [O] \xrightarrow{dilute\ H_2SO_4,\ limited\ K_2Cr_2O_7} CH_3CHO + H_2O}$$

![IMG](<../../assets/img/as-chem/C15-img (5).png>)

##### 2. Oxidation of Primary Alcohol to Carboxylic Acid
- **Conditions**: Concentrated sulfuric acid, **excess** oxidising agent, **heating under reflux**
- **Reflux purpose**: Vapours are condensed and returned to the reaction flask, ensuring complete oxidation and preventing loss of volatile reactants/products

**Example**: Oxidation of ethanol to ethanoic acid
$$\mathrm{CH_3CH_2OH + 2[O] \xrightarrow{conc\ H_2SO_4,\ excess\ K_2Cr_2O_7,\ reflux} CH_3COOH + H_2O}$$

![IMG](<../../assets/img/as-chem/C15-img (7).png>)

##### 3. Oxidation of Secondary Alcohol to Ketone
- **Conditions**: Acidified potassium dichromate(VI), heating
- **Product**: Ketone (cannot be oxidised further under these conditions)
...
|---------|-----------|---------|
| **Structure** | Carbonyl group at the **end** of the hydrocarbon chain | Carbonyl group in the **middle** of the hydrocarbon chain |
| **General formula** | $\mathrm{RCHO}$ | $\mathrm{RCOR'}$ |
| **Suffix** | -al | -one |
| **Examples** | Ethanal ($\mathrm{CH_3CHO}$) | Propanone ($\mathrm{CH_3COCH_3}$) |

![IMG](<../../assets/img/as-chem/C15-img (10).png>)

> Note: Many aldehydes and ketones have characteristic pleasant smells.