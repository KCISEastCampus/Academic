...
> **Exam info**: OxfordAQA 9201 · Linear qualification · 2 papers (1h 30m each, 90 marks each) · 9-point grading (1–9)
>
...
- **Mitochondria** — where most energy is released (respiration)
- **Ribosomes** — where protein synthesis occurs

**Plant cells** (also eukaryotic) additionally have:
- **Chloroplasts** — absorb light energy to make food
- **Permanent vacuole** filled with cell sap
- **Cell wall** (cellulose) — strengthens the cell

**Bacterial (prokaryotic) cells**: cytoplasm + membrane surrounded by a cell wall; genes not in a distinct nucleus; some genes in **plasmids** (circular structures).
...
- **Spongy mesophyll** — has air spaces to facilitate gas diffusion.
...
- **Active transport**: movement of substances **against** a concentration gradient, requiring energy from respiration.

> 📝 Key terms: **isotonic** (same concentration), **hypotonic** (lower), **hypertonic** (higher), **turgor** (plant cell swollen with water), **plasmolysis** (plant cell shrinks as water leaves).

🔬 **Required practical**: Investigate the effect of different concentrations of solutions separated by a partially permeable membrane.

**Exchange surfaces** are made effective by:
- Large surface area, thin (short diffusion path)
...
3. Does active transport need energy? **(Yes — from respiration)**
4. What do xylem and phloem transport? **(Water/minerals; dissolved sugars)**
...
- **Limiting factors**: low temperature, shortage of CO₂, shortage of light. Any one can limit the rate.
...
- **Phloem**: carries dissolved sugars (leaves → rest of plant). This is **translocation**.
...
- **Coronary heart disease**: fatty material narrows coronary arteries → lack of oxygen to heart muscle. Treated with **stents**.
- Faulty heart valves can be replaced (biological or mechanical). **Artificial hearts** keep patients alive awaiting transplant.

**Blood vessels**:
- **Arteries** — thick walls with muscle and elastic fibres.
- **Veins** — thinner walls, often have valves to prevent back-flow.
- **Capillaries** — very narrow, thin-walled; substances pass in/out.

**Blood components**:

| Component | Key feature | Function |
|---|---|---|
| **Plasma** | fluid | carries CO₂, digested products, urea |
| **Red blood cells** | no nucleus, haemoglobin | carry oxygen (forms oxyhaemoglobin) |
| **White blood cells** | have nucleus | defence against microorganisms |
| **Platelets** | small fragments, no nucleus | help blood to clot (fibrinogen → fibrin) |
...
| Enzyme | Produced by | Breaks down | Into |
|---|---|---|---|
| **Amylase** | salivary glands, pancreas, small intestine | starch | sugars |
...
- **Bile** (produced by liver, stored in gall bladder): neutralises stomach acid and **emulsifies fats** (increases surface area for lipase).
...
**To exhale**: muscles relax → volume decreases → pressure increases → air leaves.
...
- Takes place continuously in plants and animals; most reactions in **mitochondria**.

**Anaerobic respiration in muscles** (insufficient oxygen):

$$\text{glucose} \rightarrow \text{lactic acid} \quad (C_6H_{12}O_6 \rightarrow 2C_3H_6O_3)$$

- Causes a build-up of **lactic acid** and an **oxygen debt** to be repaid.
- Much less energy is transferred than in aerobic respiration.
- In plants and some microorganisms: produces **ethanol + carbon dioxide**.

**During exercise**: heart rate increases, breathing rate/depth increases, glycogen → glucose.
...
3. What is produced in anaerobic respiration in muscles? **(Lactic acid)**
4. What does bile do? **(Neutralises acid + emulsifies fats)**
...
- **Extremophiles**: organisms living in extreme environments (high salt, high temperature, high pressure).
...
3. List the steps of eutrophication. **(Algae boom → die → microbes → oxygen depleted → aerobic death)**
...
- At a **synapse**, a chemical is released to pass the impulse to the next neurone.
...
- **Too low**: pancreas produces **glucagon** → glycogen converted to glucose and released.
...
- **Vaccination**: introducing dead/inactive pathogens → stimulates antibody production → immunity. (e.g. MMR vaccine)
- **Antibiotics** (e.g. penicillin) kill bacteria, but **cannot kill viruses**.
- **Antibiotic resistance**: pathogens mutate → resistant strains survive and reproduce (e.g. MRSA). Overuse of antibiotics increases resistance. → Need new antibiotics.
...
3. How does sweating cool the body? **(Evaporation of sweat transfers energy away)**
4. Can antibiotics kill viruses? **(No)**
...
- **Mitosis**: body cells divide once → two genetically identical body cells (growth, repair).
- **Meiosis**: cells divide twice → four gametes, each with a single set of chromosomes.
- **Stem cells** (from embryos and adult bone marrow) can differentiate into many cell types.
...
- **Homozygous**: both chromosomes have the same allele. **Heterozygous**: different alleles.
- **Dominant allele**: controls development when present on one chromosome. **Recessive allele**: only controls development if the dominant allele is not present.
...
3. What is a gene? **(A small section of DNA coding for a protein)**
...
- **Evolution via natural selection**:
  ...
  2. Individuals best suited to the environment are more likely to survive and breed.
  3. The genes that enabled survival are passed to the next generation.
...
3. **Evaluation**: critique methods, suggest improvements, consider validity/repeatability/reproducibility.
...
- **Diagrams**: label cell structures, the heart, the digestive system, the carbon cycle.
- **Mind maps**: link topics (e.g. photosynthesis ↔ respiration).

---

*OxfordAQA International GCSE Biology (9201). Latest spec: [oxfordaqa.com/9201](https://oxfordaqa.com/9201).*
